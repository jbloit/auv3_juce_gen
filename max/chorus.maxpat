...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 237.0, 36.0, 150.0, 20.0 ],
					"style" : "",
					"text" : "chorus from BEAP"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 317.0, 150.377502, 42.0, 22.0 ],
					"style" : "",
					"text" : "*~ 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 184.907501, 65.0, 22.0 ],
					"style" : "",
					"text" : "center $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 469.0, 184.907501, 43.0, 22.0 ],
					"style" : "",
					"text" : "bw $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 534.0, 184.907501, 50.0, 22.0 ],
					"style" : "",
					"text" : "rate $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 602.0, 184.907501, 37.0, 22.0 ],
					"style" : "",
					"text" : "fb $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 602.0, 114.377502, 44.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 151.75, 58.0, 44.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 534.0, 114.377502, 44.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 106.5, 58.0, 44.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 469.0, 114.377502, 44.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 61.25, 58.0, 44.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 392.0, 114.377502, 44.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 58.0, 44.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 478.5, 216.907501, 326.5, 216.907501 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 401.5, 216.907501, 326.5, 216.907501 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 611.5, 216.907501, 326.5, 216.907501 ],
					"source" : [ "obj-9", 0 ]
				}
